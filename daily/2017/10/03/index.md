...
comments: true
navigation: '<< [Daily Dose for 2017.10.02](/daily/2017/10/02/) &#124; [Oct 2017](/daily/2017/10/) &#124; [2017](/daily/2017/) &#124; [Daily Dose for 2017.10.04](/daily/2017/10/04/) >>'
published: true
---
...
<div class="image-box"><a href="{{site.url}}/daily/2017/10/03/#apress-daily"><img class="resize" alt="PHP Beyond the Web" src="/assets/img/learning/apress/php-beyond-the-web.png"/></a></div>
<div class="image-box"><a href="{{site.url}}/daily/2017/10/03/#manning-daily-1"><img class="resize" alt="OAuth 2 in Action" src="/assets/img/learning/manning/oauth-2-in-action.png"/></a></div>
<div class="image-box"><a href="{{site.url}}/daily/2017/10/03/#manning-daily-2"><img class="resize" alt="SPA Design and Architecture" src="/assets/img/learning/manning/spa-design-and-architecture.png"/></a></div>
<div class="image-box"><a href="{{site.url}}/daily/2017/10/03/#manning-daily-3"><img class="resize" alt="Irresistible APIs" src="/assets/img/learning/manning/irresistible-apis.png"/></a></div>
<div class="image-box"><a href="{{site.url}}/daily/2017/10/03/#new1"><img class="resize" alt="Serverless Apps with Node and Claudia.js" src="/assets/img/learning/manning/serverless-apps-with-node-and-claudia-js-meap.png"/></a></div>
...
### <a name="apress-daily"></a><small>$9.99</small> [PHP Beyond the Web](http://www.anrdoezrs.net/links/8423497/type/dlg/http://www.apress.com/us/book/9781484224809)
[![PHP Beyond the Web](/assets/img/learning/apress/php-beyond-the-web.png)](http://www.anrdoezrs.net/links/8423497/type/dlg/http://www.apress.com/us/book/9781484224809)
[$9.99 Apress eBook](http://www.anrdoezrs.net/links/8423497/type/dlg/http://www.apress.com/us/book/9781484224809) by Rob Aley. This book covers PHP.
...
### <a name="manning-daily-1"></a><small>50% off</small> [OAuth 2 in Action](https://www.manning.com/dotd) 
[![OAuth 2 in Action](/assets/img/learning/manning/oauth-2-in-action.png)](https://www.manning.com/dotd)
[50% off Manning's eBook](https://www.manning.com/dotd) by Justin Richer, Antonio Sanso with foreword by Ian Glazer. This book covers OAuth 2, JSON Web Token, Jose, OpenID Connect, User-Managed Access.
...
### <a name="manning-daily-2"></a><small>50% off</small> [SPA Design and Architecture](https://www.manning.com/dotd) Understanding Single-Page Web Applications
[![SPA Design and Architecture](/assets/img/learning/manning/spa-design-and-architecture.png)](https://www.manning.com/dotd)
[50% off Manning's eBook](https://www.manning.com/dotd) by Emmit A. Scott, Jr. with foreword by Burke Holland. This book covers SPA, MV* Framework.
...
### <a name="manning-daily-3"></a><small>50% off</small> [Irresistible APIs](https://www.manning.com/dotd) Designing web APIs that developers will love
[![Irresistible APIs](/assets/img/learning/manning/irresistible-apis.png)](https://www.manning.com/dotd)
[50% off Manning's eBook](https://www.manning.com/dotd) by Kirsten L. Hunter, Adrian Cockcroft. This book covers Web API.
...
### <a name="new1"></a>[Serverless Apps with Node and Claudia.js](https://www.manning.com/books/serverless-apps-with-node-and-claudiajs)
[![Serverless Apps with Node and Claudia.js](/assets/img/learning/manning/serverless-apps-with-node-and-claudia-js-meap.png)](https://www.manning.com/books/serverless-apps-with-node-and-claudiajs)
[Serverless Apps with Node and Claudia.js](https://www.manning.com/books/serverless-apps-with-node-and-claudiajs)  by Slobodan Stojanovic, Aleksandar Simovic. This book covers Node.js, Claudia.js, AWS Lambda, API Gateway, Microservices, Amazon Alexa.
...
* [AWS DynamoDB Deep Dive](https://app.pluralsight.com/library/courses/aws-dynamodb-deep-dive/table-of-contents) (Video) by Ivan Mushketyk
* [Fundamentals of Professional Level Design](https://app.pluralsight.com/library/courses/fundamentals-professional-level-design/table-of-contents) (Video) by Barret Hudson
* [ITIL® Foundation: Core Concepts](https://app.pluralsight.com/library/courses/itil-foundation-core-concepts/table-of-contents) (Video) by Chris Ward
* [ITIL® Foundation: Lifecycle Phases and Processes](https://app.pluralsight.com/library/courses/itil-foundation-lifecycle-phases-processes/table-of-contents) (Video) by Chris Ward
